...
#define EMBER_AF_GENERATED_EVENT_CODE \
  ...
  extern EmberEventControl CloseIndicateLedEventControl; \
  extern EmberEventControl IADCCollectEventControl; \
  extern EmberEventControl KeepConnectEventControl; \
  extern EmberEventControl LedJoinNetworkStatusEventControl; \
  ...
  extern EmberEventControl emberAfCustomGpioKeyDebounceEventControl; \
  extern EmberEventControl emberAfCustomGpioKeyInterruptEventControl; \
  ...
  extern void CloseIndicateLedEventHandler(void); \
  extern void IADCCollectEventHandler(void); \
  extern void KeepConnectEventHandler(void); \
  extern void LedJoinNetworkStatusEventHandler(void); \
  ...
  extern void emberAfCustomGpioKeyDebounceEventHandler(void); \
  extern void emberAfCustomGpioKeyInterruptEventHandler(void); \
...
#define EMBER_AF_GENERATED_EVENTS   \
  ...
  { &CloseIndicateLedEventControl, CloseIndicateLedEventHandler }, \
  { &IADCCollectEventControl, IADCCollectEventHandler }, \
  { &KeepConnectEventControl, KeepConnectEventHandler }, \
  { &LedJoinNetworkStatusEventControl, LedJoinNetworkStatusEventHandler }, \
  ...
  { &emberAfCustomGpioKeyDebounceEventControl, emberAfCustomGpioKeyDebounceEventHandler }, \
  { &emberAfCustomGpioKeyInterruptEventControl, emberAfCustomGpioKeyInterruptEventHandler }, \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS   \
  ...
  "Close indicate led event control",  \
  "I a d c collect event control",  \
  "Keep connect event control",  \
  "Led join network status event control",  \
  "Sent zone status event control",  \
  "Ember af custom gpio button debounce event control",  \
  "Ember af custom gpio button interrupt event control",  \
  "Ember af custom gpio key debounce event control",  \
  "Ember af custom gpio key interrupt event control",  \
